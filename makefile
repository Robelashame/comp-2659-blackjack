...
SRCS = asynch.c bmaps.c card.c cond.c dealer.c deck.c font.c \
       ...
       raster.c render.c synch.c time.c timer.c splash.c psg.c music.c effects.c ikbd_isr.c ikbdlow.c

# Object files
OBJS = asynch.o bmaps.o card.o cond.o dealer.o deck.o font.o \
       game.o hand.o handle.o input.o model.o player.o \
       raster.o render.o synch.o time.o timer.o splash.o psg.o music.o effects.o ikbd_isr.o ikbdlow.o
